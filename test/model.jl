...
## TODO: Timing group.
# TODO: Basic tests for accessors.
...
### TODO: Model building blocks group.
## TODO: HR model group.
# TODO: Basic test: shifts and optimisation starts at the same time.
date = DateTime(2017, 01, 01, 08)
t = Timing(timeBeginning=date, timeHorizon=Day(2), timeStepDuration=Hour(1), shiftBeginning=date, shiftDuration=Hour(8))
...
### TODO: Global model group.
## TODO: Production model group.
e1 = Equipment("EAF", :eaf)
e2 = Equipment("LF", :lf)
e3 = Equipment("CC", :cc)
r1 = NormalRoute(e1, e2)
...
### TODO: Team model group.
## TODO: Fixed schedules group.
# TODO: 5-8 schedule.
