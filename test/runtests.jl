...
include("../src/IndustrialProcessFlexibilisation.jl")
include("data.jl")
include("model.jl")
include("utils.jl")
...
epRaw = readcsv("F:/Univ/_PhD/Industore/Hg/WeeklyPlanning/data/electricity_prices_2013.csv")[1:length(epDates)]
...
m = modelMultiple(p, ob, t, o, canWorkDays, canWorkNights, priorNoticeDelay, notificationFrequency, completeHorizon, 2 * optimisationHorizon, optimisationHorizon, hoursPerShift, timeBetweenShifts, consecutiveDaysOff, maxHoursPerWeek, hoursContract, (1., 1., 1., 1., 1.), :smart, CplexSolver(), outFolder="f:/_/")

# status, pm, m, shiftsOpen, productionRaw = productionModel(p, ob, t, o)
nothing
