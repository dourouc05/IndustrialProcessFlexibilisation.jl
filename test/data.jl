## TODO: Group "datastructures"

## TODO: Subgroup equipment.
...
# Checking for equality only works on the name.
e1 = Equipment("EAF", :eaf)
e2 = Equipment("EAF B", :eaf)
e3 = Equipment("EAF", :lf)
@test(e1 != e2)
...
## TODO: Subgroup plants (constructors).
...
le = [e1, e2, e3]
lr = Route[r1, r2]
@test_throws(ErrorException, Plant(lr) == Plant(lr))
...
## TODO: Subgroup plants (getters for routes)
...
## TODO: Subgroup consumption models.
...
## TODO: Subgroup timing.
# TODO: Generic helper functions.
